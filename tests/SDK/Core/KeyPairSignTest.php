    ...
    extends TestCase
{
    ...
    public function testBasicKeyPairSign()
    {
        ...
        //[150, 138, 237, 214, 135, 191, 84, 26, 42, 125, 101, 203, 211, 22, 246, 141, 228, 123, 96, 140, 255, 163, 25, 4, 243, 113, 75, 68, 133, 34, 20, 244, 71, 178, 13, 242, 238, 54, 184, 250, 47, 17, 244, 145, 170, 61, 225, 62, 39, 222, 249, 105, 186, 223, 172, 109, 111, 122, 2, 1, 185, 15, 173, 13]
        ...
        $this->assertEquals($expectHex, $kp1->sign("Hello, World!", "hex"));
    }
